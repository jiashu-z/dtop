...
class GRPCService final {
 public:
  ...
  typedef WithAsyncMethod_GetIP<WithAsyncMethod_GetPort<WithAsyncMethod_GetAddr<Service > > > AsyncService;
  template <class BaseClass>
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_GetIP<ExperimentalWithCallbackMethod_GetPort<ExperimentalWithCallbackMethod_GetAddr<Service > > > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_GetIP<ExperimentalWithCallbackMethod_GetPort<ExperimentalWithCallbackMethod_GetAddr<Service > > > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_GetIP<WithStreamedUnaryMethod_GetPort<WithStreamedUnaryMethod_GetAddr<Service > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GetIP<WithStreamedUnaryMethod_GetPort<WithStreamedUnaryMethod_GetAddr<Service > > > StreamedService;
};
