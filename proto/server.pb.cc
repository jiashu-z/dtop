...
const char descriptor_table_protodef_server_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "FetchRequestMessage\032\022.FetchReplyMessage\022"
  "<\n\017GetServerStatus\022\023.StringArrayMessage\032"
  "\024.ServerStatusMessageB\031\n\027grp.dtop.dtopja"
  "va.protob\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_server_2eproto = {
  false, false, 376, descriptor_table_protodef_server_2eproto, "server.proto", 
