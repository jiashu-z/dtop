...
bool dtop::worker::MemUsageWorker::handle_start() { return true; }
...
bool dtop::worker::MemUsageWorker::handle_pause() { return true; }

bool dtop::worker::MemUsageWorker::handle_stop() { return true; }
